...
function baseSnapshot(cycleId: string, proposed: Decision, cyclePlan: CycleDecisionPlan, riskGateResult: RiskGateResult, preTradeAccount: AccountSnapshot, postTradeAccount: AccountSnapshot, scenario: DemoScenario, title: string, evidenceLabel: DemoSnapshot["demo"]["evidenceLabel"], activities: string[]): DemoSnapshot {
  ...
  return {
    ...
    accountPerformance: {
      ...
      financialRecordCoverage: "UNAVAILABLE",
    ...
    scheduler: { completedCycles: 0, averageDurationMs: 0, maxDurationMs: 0, inProgressCount: 0, staleCount: 0, failureCount: 0, timeoutCount: 0, nextScanAt: null, nextScanStale: false, configuredIntervalMinutes: 15, matchingScheduleCount: 0, schedulerHealthy: true, tradingSchedulerHealthy: false, providerSyncSchedulerHealthy: false },
